export default class Or_3{
    ...
    draw = ()=>{
        let or_3 = document.getElementById("or_3")
        if(!this.selected){
            or_3 = document.getElementById("or_3")
        }
        else{
            or_3 = document.getElementById("or_31")
        }
        this.simulation.context.drawImage(or_3, this.position.x, this.position.y, 94, 75);
    }
