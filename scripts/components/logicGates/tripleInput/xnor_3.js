export default class Xnor_3{
    ...
    update = ()=>{
        if(this.inputIds[0]!=undefined && this.inputIds[1]!=undefined && this.inputIds[2]!=undefined)
            this.value = !((this.simulation.components[this.inputIds[0]].value && !this.simulation.components[this.inputIds[1]].value || !this.simulation.components[this.inputIds[0]].value && this.simulation.components[this.inputIds[1]].value) && !this.simulation.components[this.inputIds[2]].value || !(this.simulation.components[this.inputIds[0]].value && !this.simulation.components[this.inputIds[1]].value || !this.simulation.components[this.inputIds[0]].value && this.simulation.components[this.inputIds[1]].value) && this.simulation.components[this.inputIds[2]].value)
        this.draw()
    }
}