export default class And_3{
    ...
    draw = ()=>{
        let and_3 = document.getElementById("and_3")
        if(!this.selected){
            and_3 = document.getElementById("and_3")
        }
        else{
            and_3 = document.getElementById("and_31")
        }
        this.simulation.context.drawImage(and_3, this.position.x, this.position.y, 94, 75);
    }
