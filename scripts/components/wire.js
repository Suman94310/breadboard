...
export default class Wire{
    ...
    isClicked = (position)=>{
        ...
        if(position.x > this.left.position.x + this.left.nodeOffset.x && 
            position.x < this.right.position.x + this.right.nodeOffset.x &&
            position.y < this.left.position.y + this.left.nodeOffset.y && 
            position.y > this.right.position.y + this.right.nodeOffset.y){
            for(let i=0; i<this.adaptivePts.length; i++){
                if(position.x < this.adaptivePts[i][0] ){
